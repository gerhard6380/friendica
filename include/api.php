...
function api_format_item($item, $type = "json", $status_user = null, $author_user = null, $owner_user = null)
{
	...
	$status = [
		...
		'friendica_html' => $converted["renderedhtml"],
	...
	if (!empty($quoted_item)) {
		...
		$quoted_status['friendica_html'] = $conv_quoted['renderedhtml'];
		try {
	...
	if (!empty($retweeted_item)) {
		...
		$retweeted_status['friendica_html'] = $rt_converted['renderedhtml'];
		...
		$status['friendica_html'] = $root_status["renderedhtml"];
